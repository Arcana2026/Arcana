...
//
// Arcana_Verified.sol - Fichier unique pour verification PolygonScan
// CONTRAT ATTENDU PAR POLYGONSCAN : ArcanaPresaleVault (doit etre le dernier du fichier)
//
// Parametres a saisir sur PolygonScan :
...
// ============ Dependances (OpenZeppelin) - Ne pas modifier l'ordre ============
...
// ============ CONTRAT PRINCIPAL - DOIT RESTER EN DERNIER (PolygonScan) ============
