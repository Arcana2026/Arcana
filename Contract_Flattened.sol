...
// =============================================================================
// Contract_Flattened.sol — Pour vérification PolygonScan
// Contient : Context, Ownable, ReentrancyGuard, IERC20, SafeERC20 + contrat principal.
// Si votre bytecode déployé diffère, remplacez le contrat ArcanaPresaleVault par
// votre source exacte et utilisez "Flatten" de votre IDE (Hardhat/Foundry) pour
// inclure les vrais fichiers OpenZeppelin.
// =============================================================================
...
// ============ OpenZeppelin: SafeERC20 (stub - no low-level calls) ============
library SafeERC20 {
...
// ============ Main Contract: Arcana Presale / Vault ============
